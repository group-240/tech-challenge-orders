...
class PaymentApiClientTest {
    ...
    void testShouldCreatePaymentApiClientWithBaseUrl() {
        // Act
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(), 3000, 3000);
    ...
    void testShouldThrowExceptionWhenApiCallFails() {
        ...
        PaymentApiClient client = new PaymentApiClient(TestConfig.INVALID_URL, 3000, 3000);
    ...
    void testShouldThrowExceptionWhenConnectionRefused() {
        ...
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(TestConfig.PAYMENT_API_PORT_INVALID), 3000, 3000);
    ...
    void testShouldFormatJsonPayloadCorrectly() {
        // Arrange
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(TestConfig.PAYMENT_API_PORT_NULL_VALUES), 3000, 3000);
    ...
    void testShouldHandleSpecialCharactersInDescription() {
        // Arrange
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(TestConfig.PAYMENT_API_PORT_JSON_FORMAT), 3000, 3000);
    ...
    void testShouldHandleDifferentInstallmentValues() {
        // Arrange
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(TestConfig.PAYMENT_API_PORT_SPECIAL_CHARS), 3000, 3000);
    ...
    void testShouldHandleDifferentAmountFormats() {
        // Arrange
        PaymentApiClient client = new PaymentApiClient(TestConfig.getPaymentApiUrl(TestConfig.PAYMENT_API_PORT_INSTALLMENTS), 3000, 3000);

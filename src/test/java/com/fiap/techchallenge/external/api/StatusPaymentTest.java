...
public class StatusPaymentTest {
    ...
    public void testShouldMapPendingStatusesToAguardandoPagamento() {
    ...
    public void testShouldMapApprovedStatusToAprovado() {
    ...
    public void testShouldMapRejectedStatusesToRejeitado() {
    ...
    public void testShouldThrowExceptionForUnknownStatus() {
